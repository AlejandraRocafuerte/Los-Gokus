...
nombre.change(() => {
	...
	if (nombre.val() == "goku") {
		...
		per_img.attr("src", "images/goku_6.jfif");
		...
		per_img.attr("src", "images/vegeta_2.webp");
		...
		per_img.attr("src", "images/krillin.jpg");
		...
		per_img.attr("src", "images/trunks.jpg");
		...
		per_img.attr("src", "images/piccolo_1.jpg");
		...
		per_img.attr("src", "images/dende.jpg");
		...
		per_img.attr("src", "images/boo_3.jpg");
		...
		per_img.attr("src", "images/black_1.jfif");
		...
		per_img.attr("src", "images/shin.webp");
...
transformacion.change(() => {
	...
	switch (transformacion.val()) {
		case "1":
			imagen.attr("src", "images/goku_1.webp");
			comparacion.html(pierde);
			break;
		case "2":
			imagen.attr("src", "images/goku_2.jpg");
			comparacion.html(pierde);
			break;
		case "3":
			imagen.attr("src", "images/goku_3.webp");
			comparacion.html(gana);
			break;
		case "4":
			imagen.attr("src", "images/goku_4.jpg");
			comparacion.html(gana);
			break;
		case "5":
			imagen.attr("src", "images/goku_5.jpg");
			comparacion.html(gana);
			break;
		case "6":
			imagen.attr("src", "images/goku_6.jfif");
			comparacion.html(gana);
			break;
		case "7":
			imagen.attr("src", "images/vegeta_1.jfif");
			comparacion.html(gana);
			break;
		case "8":
			imagen.attr("src", "images/vegeta_2.webp");
			comparacion.html(gana);
			break;
		case "9":
			imagen.attr("src", "images/vegeta_3.webp");
			comparacion.html(gana);
			break;
		case "10":
			imagen.attr("src", "images/vegeta_4.jpg");
			comparacion.html(gana);
			break;
		case "11":
			imagen.attr("src", "images/krillin.jpg");
			comparacion.html(pierde);
			break;
		case "12":
			...
			break;
		case "13":
			imagen.attr("src", "images/piccolo_1.jpg");
			comparacion.html(gana);
			break;
		case "14":
			imagen.attr("src", "images/piccolo_2.jpg");
			comparacion.html(gana);
			break;
		case "15":
			imagen.attr("src", "images/piccolo_3.jfif");
			comparacion.html(gana);
			break;
		case "16":
			imagen.attr("src", "images/piccolo_4.jpg");
			comparacion.html(gana);
			break;
		case "17":
			...
			break;
		case "18":
			imagen.attr("src", "images/boo_1.jpg");
			comparacion.html(gana);
			break;
		case "19":
			imagen.attr("src", "images/boo_2.jpg");
			comparacion.html(gana);
			break;
		case "20":
			imagen.attr("src", "images/boo_3.jpg");
			comparacion.html(pierde);
			break;
		case "21":
			imagen.attr("src", "images/boo_4.jpg");
			comparacion.html(gana);
			break;
		case "22":
			imagen.attr("src", "images/black_1.jfif");
			comparacion.html(gana);
			break;
		case "23":
			imagen.attr("src", "images/black_2.webp");
			comparacion.html(gana);
			break;
		case "24":
			imagen.attr("src", "images/shin.webp");
			comparacion.html(gana);
			break;
		default:
			imagen.attr("src", "images/camara.png");
